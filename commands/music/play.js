    ...
    if (!message.guild.me.hasPermission("CONNECT")) {
      message.channel.send({
        embed: {
          color: "FF0000",
          description:
            "<:exclamation:763367241327706118> I don't have permission to connect your vc!"
        }
      });
    }
    if (!message.guild.me.hasPermission("SPEAK")) {
      message.channel.send({
        embed: {
          color: "FF0000",
          description:
            "<:exclamation:763367241327706118>I need speak permission for playing music!"
        }
      });
    }
    var searchString = args.join(" ");
    if (!searchString) {
      message.channel.send("<:exclamation:763367241327706118>provide us song' name or song's link");
    }
